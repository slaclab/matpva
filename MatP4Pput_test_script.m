...
% Test Scalar PVs
MatP4Pput('TEST:PVA:IntValue', IntValue)
MatP4Pput('TEST:PVA:FloatValue', FloatValue)
MatP4Pput('TEST:PVA:BoolValue', BoolValue)
MatP4Pput('TEST:PVA:ByteValue', ByteValue)
MatP4Pput('TEST:PVA:ShortValue', ShortValue)
MatP4Pput('TEST:PVA:StringValue', StringValue)
...
% Test Array PVs
MatP4Pput('TEST:PVA:IntArray', ai)
MatP4Pput('TEST:PVA:ShortArray', ah)
MatP4Pput('TEST:PVA:DoubleArray', ad)
MatP4Pput('TEST:PVA:FloatArray', af)
MatP4Pput('TEST:PVA:BoolArray', ab)
MatP4Pput('TEST:PVA:StringArray', as)
...
% 
% Test NTTable PVs
MatP4Pput('TEST:PVA:NTTable', "name", Name, "number", Number)
...
MatP4Pput('TBLEM:SYS0:1:CU_HXR:LIVE:TWISS', "element", Element, "device_name", Device_name, "s", S, "z", Z, "length", Length,...
